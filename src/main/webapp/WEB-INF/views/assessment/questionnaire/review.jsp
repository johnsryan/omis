...
<body>
<h1>
	<a class="actionMenuItem" id="actionMenuLink" href="${pageContext.request.contextPath}/assessment/questionnaire/reviewAssessmentActionMenu.html?administeredQuestionnaire=${administeredQuestionnaire.id}"></a>
	<c:choose>
